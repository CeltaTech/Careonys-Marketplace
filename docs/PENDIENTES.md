...
| # | Pendiente | Se cierra cuando |
|---|---|---|
| 18 | **El Asistente no tiene dónde decir si quiere ser publicado.** Faltan cuatro banderas del legajo: disponible para reemplazos urgentes, visible para las Familias, visible en la vidriera y para los buscadores, y comparte su teléfono con quien lo contacta. Las tres últimas son el consentimiento de la persona para que su perfil se muestre. Sin ellas, **publicar un legajo es una decisión que toma el sistema por alguien que no la tomó** | El legajo las guarde, la vidriera las respete y el consentimiento quede del lado compartido, como dice `docs/MODULOS.md`. Es condición para cargar el primer legajo real, igual que el pendiente 1 |
| 19 | **Una Matrícula no tiene dónde guardarse.** El glosario la define con número, vigencia y archivo, y el catálogo ya dice qué tipos de Asistente la exigen, pero el único lugar que hay para un estudio es `nivel_educativo`, una lista cerrada de cuatro opciones. Faltan tres fichas repetibles: estudio o curso, experiencia laboral y referencia | Existan las tres fichas y la Matrícula guarde número, vigencia y archivo. **Un tipo de Asistente que exige Matrícula y no la puede cargar no se puede habilitar**, así que esto bloquea el alta de esos tipos |
