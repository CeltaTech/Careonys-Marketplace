...
>
> **Y lo que ya no promete.** La versión anterior tenía un capítulo entero de Packs de
> Contactos, Suscripciones Premium, renovación automática debitada de una tarjeta y política de
> reembolsos. **Nada de eso existe en este software** —no hay tarjeta, no hay cobro, no hay
> renovación—, así que se sacó. Lo que ocupa su lugar es la §6, que dice la verdad: acá no se
> cobra nada.

| | |
|---|---|
| **A quién le habla** | A la persona que busca o contrata cuidado para alguien: la **Familia** |
| **De quién son estos términos** | De la **Prestadora** que presta el servicio |
...
tipo tiene sus propias exigencias de título y de matrícula.

**1.5. CeltaTech.** Es la empresa que desarrolla y licencia el software. **No presta cuidado, no
...
profesional. El diagnóstico, las indicaciones y las recetas son del médico tratante del
Paciente, que este software no conoce ni consulta.

**2.3. Qué no hace en una urgencia.** El software **no llama a nadie por usted**. Ante una
urgencia se llama al servicio de emergencias que corresponda, y recién después se anota lo que
pasó. Ninguna pantalla, ningún aviso y ninguna alarma de este software sustituyen esa llamada.

**2.4. Qué no garantiza el software.** Que un Asistente aparezca en una pantalla no es una
recomendación de este software ni un aval sobre su idoneidad. Lo que se muestra es lo que la
...
**4.2. Usted declara que puede cargarlos.** Al cargar datos de salud de otra persona, usted
declara que está en condiciones de hacerlo: porque el Paciente lo autorizó, o porque usted tiene
sobre él una responsabilidad legal que se lo permite. **Este software no puede comprobarlo**, y
por eso se lo pide dicho.

**4.3. Qué escribir y qué no.** Escriba lo que hace falta para que el cuidado se pueda prestar, y
...
que paga**, en números agregados: cuántas horas, cuántas guardias, cuántas ausencias. **Nunca ve
qué se escribió sobre el Paciente.**
...
**5.1. Qué se le pide.** Al pedir cuidado se le pide su nombre, su correo y su celular, y el
motivo de la consulta. Es lo mínimo para que su Prestadora pueda contestarle.

**5.2. Para qué se usan.** Para que su Prestadora se comunique con usted y organice el servicio.
No se venden, no se ceden a terceros y no se usan para otra cosa, salvo que una ley lo exija.

**5.3. Novedades.** Si eligió recibir novedades, puede dejar de recibirlas cuando quiera. Es una
opción, nunca una condición para usar el software.

**5.4. Sus derechos.** Por la **Ley 25.326 de Protección de los Datos Personales** usted puede
...
**6.1. Este software no cobra nada.** No pide una tarjeta, no debita, no factura, no cobra
comisión y no liquida honorarios. **No hay ninguna suscripción que se renueve sola**, porque no
...
tener que aceptarlo aparte. **Nada de lo que usted acepta hoy lo obliga a pagar nada.**

---

## 7. Qué se ve y qué no se ve

**7.1. El directorio es público.** Las fichas de los Asistentes publicados **se ven sin iniciar
...
**8.1. Es suya y no se presta.** Su clave es personal. Todo lo que se haga con su cuenta se
cuenta como hecho por usted.
...
**9.1. Usted puede irse cuando quiera.** Pídalo a su Prestadora. Que se vaya no borra lo que ya
ocurrió, por lo dicho en la §5.5.

**9.2. La Prestadora puede darlo de baja.** Puede hacerlo si usted incumple estos términos, si
carga datos falsos, si usa el software para algo que no es organizar un cuidado, o por las
razones que su contrato con ella prevea. Tiene que decirle cuál fue el motivo.
...
**10.4. Lo que ninguna de las tres cubre.** Una urgencia médica. Para eso está el servicio de
emergencias, y la §2.3.

---

## 11. Cambios de este documento

**11.1. Cómo cambia.** Este documento cambia. Cuando cambie, la fecha de la tabla de arriba se
actualiza y el cambio se anota abajo. Si un cambio afecta algo que usted ya aceptó, se le pide
