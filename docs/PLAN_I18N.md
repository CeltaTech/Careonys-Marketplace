...
> chequeo abre (`scripts/recorrido.mjs:148`); el porqué está en `docs/ALCANCE.md`. Sus 119 frases
...
- **Los nombres comerciales.** La regla de la empresa los exceptúa: un plan que se llama de una
  ...
  `IGUALES_EN_TODOS` (`scripts/verificar_frases.mjs:96`) —las cuatro redes sociales, los tres
