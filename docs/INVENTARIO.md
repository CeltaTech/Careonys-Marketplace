...
En `scripts/` hay **53 archivos `.mjs` y uno de Python**: 29 chequeos `verificar_*`, 11 pruebas `probar_*` y 13 herramientas sueltas —medidores, generadores, el módulo que comparten y el servidor de trabajo—.
