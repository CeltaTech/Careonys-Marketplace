...
En `scripts/` hay **57 archivos `.mjs` y uno de Python**: 29 chequeos `verificar_*`, 12 pruebas `probar_*` y 16 herramientas sueltas —medidores, generadores, el módulo que comparten y el servidor de trabajo—.
