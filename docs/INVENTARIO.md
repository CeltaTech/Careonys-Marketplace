...
En `scripts/` hay **59 archivos `.mjs` y uno de Python**: 30 chequeos `verificar_*`, 12 pruebas `probar_*` y 17 herramientas sueltas —medidores, generadores, el módulo que comparten y el servidor de trabajo—.
