...
En `scripts/` hay **67 archivos `.mjs` y uno de Python**: 36 chequeos `verificar_*`, 13 pruebas `probar_*` y 18 herramientas sueltas —medidores, generadores, el módulo que comparten y el servidor de trabajo—.
