...
En `scripts/` hay **75 archivos `.mjs` y uno de Python**: 38 chequeos `verificar_*`, 16 pruebas `probar_*` y 21 herramientas sueltas —medidores, generadores, el módulo que comparten y el servidor de trabajo—.
...
- *Traducción de datos*: `_mapFromDatabase` y `_mapToDatabase` en `js/apiClient.js:305-488`
