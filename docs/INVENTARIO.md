...
En `scripts/` hay **64 archivos `.mjs` y uno de Python**: 34 chequeos `verificar_*`, 13 pruebas `probar_*` y 17 herramientas sueltas —medidores, generadores, el módulo que comparten y el servidor de trabajo—.
