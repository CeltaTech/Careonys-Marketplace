...
| `scripts/probar_aislamiento.mjs` | Las dieciséis comprobaciones de que una Prestadora no ve los datos de la otra (la regla de la empresa «aislamiento entre Organizaciones»). Necesita las dos Prestadoras ficticias cargadas: con una sola, ver una sola no prueba nada. |
