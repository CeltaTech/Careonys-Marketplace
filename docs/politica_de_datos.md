...
—`pwa-asistente/src/pantallas/Inicio/Fichador.jsx:219` y `:235`—. La respuesta que viene puesta es **no decirlo**
—`pwa-asistente/src/pantallas/Inicio/Fichador.jsx:225`—, y con ésa la marca no sale del propio Asistente. Terminada la
marca, el aviso de confirmación muestra las coordenadas que quedaron guardadas
—`pwa-asistente/src/pantallas/Inicio/Fichador.jsx:135-141`—. Aparte de eso está el pedido de permiso que hace el
