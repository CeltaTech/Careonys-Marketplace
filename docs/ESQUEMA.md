...
> migración; ahora hay varias, y lo de abajo sigue siendo la regla con la que se escribe cada
> una. Cuántas son, y cuántas tablas hay, lo mide `node scripts/verificar_esquema.mjs`.
>
