-- ============================================================================
-- 0007 — La vidriera muestra sólo a quien dio permiso
-- ============================================================================
--
-- Qué estaba mal
-- --------------
...
-- comentario de esa tabla ya decía que la vidriera tenía que preguntarle;
...
-- tienen banderas, desaparecen de la vidriera. Está bien que desaparezcan:
-- son inventados, y ninguno contestó nada.
--
-- La foto
-- -------
-- La vidriera no tenía dónde sacar una cara. `caregivers` no tiene columna de
...
-- -------------------------------
-- Si la vidriera se ve sin iniciar sesión, y si muestra una Prestadora o
...
comment on view public.caregivers_publicos is
  'Vidriera pública. Dos condiciones, y las dos hacen falta: la Prestadora validó el legajo, y la persona marcó perfil_publicado. Nunca agregar acá una columna con datos personales: ni documento, ni teléfono, ni correo, ni domicilio, ni los caminos del depósito privado.';
