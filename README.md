...
| `verificar_esquema` | Que una tabla nueva nazca sin RLS, que una función que se saltea la RLS quede al alcance de quien no inició sesión, que falte la columna de la Organización, que la clave primaria no sea `uuid`, que un importe se guarde sin moneda, que una política del depósito de archivos no nombre la Organización —que es lo único que ahí separa a una Prestadora de otra—, o que la Organización se resuelva con un valor que venga en el pedido en vez de por la membresía de quien inició sesión |
